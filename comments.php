...
<?php if ( have_comments() ) : ?>
	...
	<h3 id="comments" class="h2"><?php comments_number(__('<span>No</span> Responses to', 'bonestheme'), __('<span>One</span> Response to', 'bonestheme'), _n('<span>%</span> Response to', '<span>%</span> Responses to', get_comments_number(),'bonestheme') );?> &#8220;<?php the_title(); ?>&#8221;</h3>
