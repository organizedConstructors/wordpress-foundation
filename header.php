...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
    ...
    <header role="banner" id="top-header">
      ...
      <div class="siteinfo">
        <?php
          $blog_name_tag = (is_home() ? 'h1' : 'span');
        ?>
        <<?php echo $blog_name_tag; ?> id="blog-name"><a class="brand" id="logo" href="<?php echo get_bloginfo('url'); ?>"><?php bloginfo('name'); ?></a></<?php echo $blog_name_tag; ?>>
        <span id="blog-description"><?php echo get_bloginfo ( 'description' ); ?></span>
      </div>
